...
const FazlaLink = Hata(
  `${Çarpı} **Premium bir kullanıcı tarafından en fazla 10 link eklenebilir.**`
);
...
const SistemMesajı = new EmbedBuilder()
  ...
  .setTitle(`${botName} || Uptime Paheli`)
  .setImage('https://cdn.discordapp.com/attachments/1105524120805969952/1170426551251251310/standard_2.gif')
  .setDescription(
    [
      "> **<a:yerimdeduramyorum:1149379174570668063> Uptime Sistemimize Hoş Geldiinn <a:yerimdeduramyorum:1149379174570668063>**",
      " ",
      "**<a:ok:1237430682666532954> Ekle butonuna tıklayarak sistemimize linkinizi ekleyebilirsin!**",
      " ",
      "**<a:ok:1237430682666532954> Listele butonuna tıklayarak linklerine göz atabilirsin!**",
      " ",
      "**<a:ok:1237430682666532954> Ücretsiz şekilde 3, premium ile 10 link ekleyebilirsin!**",
      " ",
      "> **Diğer komutlarıma erişmek için </yardım:0> komutunu kullanabilirsiniz. İyi kullanımlar :)**",
    ].join("\n")
  );
...
const DavetEmbed = new EmbedBuilder()
  .setTitle(`${botName} || Linkler Paneli`)
  .setColor(Colors.Blurple)
  .setDescription(
    [
...
const Yardım = () => {
  ...
  return new EmbedBuilder()
    .setColor(Colors.Blurple)
    .setTitle(`${botName} || Yardım Paneli`)
    .setImage("https://cdn.discordapp.com/attachments/1105524120805969952/1170426551251251310/standard_2.gif?ex=662f3b6b&is=662de9eb&hm=19a2a4a577f4edfc96059dccca8e9675a8f04914f05f00caf8c00763a0887716&")
    .setDescription(
      [
...
const ProjeSilindi = (/** @type {User} */ user, /** @type {string} */ pre) =>
  ProjeDurum(user, pre)
    ...
    .setImage("https://cdn.discordapp.com/attachments/1105524120805969952/1170422555811795065/standard_1.gif")
    .setColor(Colors.Red);
const ProjeEklendi = (/** @type {User} */ user, /** @type {string} */ pre) =>
  ProjeDurum(user, pre)
    .setTitle("Sisteme bir link eklendi")
    .setImage("https://cdn.discordapp.com/attachments/1105524120805969952/1170422555224576100/standard.gif")
    .setColor(Colors.Green);
